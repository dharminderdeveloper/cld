...
define('MASTER_LOGS_DIR', MASTER_PLUGIN_DIR . 'logs/');

require_once MASTER_PLUGIN_DIR . 'includes/logger.php';
require_once MASTER_PLUGIN_DIR . 'includes/form-handler.php';
...
class Master_Service_Plugin_Main
{
    ...
    {
        if (! file_exists(MASTER_LOGS_DIR)) {
            wp_mkdir_p(MASTER_LOGS_DIR);
        }
        // deny direct access to logs via .htaccess (Apache). Silently ignore if cannot write.
        $htaccess = MASTER_LOGS_DIR . '.htaccess';
    ...
    public function enqueue_assets()
    {
        ...
        wp_enqueue_style(
            'master-frontend-css',
            MASTER_PLUGIN_URL . 'assets/css/master-service.css',
            [],
            '1.0.0'
        );
        ...
        wp_enqueue_script(
            'master-frontend-js',
            MASTER_PLUGIN_URL . 'assets/js/master-service.js',
            ['jquery'],
            '1.0.0',
            true
        );
        ...
        ?>
            <div id="contactModal" class="modal">
                <div class="modal-content" style="max-width: 900px;">
                    ...
                    <form id="masterServiceForm" enctype="multipart/form-data" novalidate>
                        <div class="d-grid grid-col-2">
                            ...
                            <div class="form-column">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        <label>Your File / Reference No</label>
                                        <input type="text" name="reference_no" placeholder="Enter your file/reference number">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="billing_address" rows="3" placeholder="Enter your billing address"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="service_deadline">
                                    </div>
                                    <div class="form-group">
                                        <label>Time</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="service_priority">
                                            ...
                                            <option value="Regular Service - $80.00">Regular Service - $80.00</option>
                            ...
                            <div class="form-column">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        <label>How do you wish Process Serving to Receive your Documents?</label>
                                        <select name="document_delivery_method">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- Hidden file input -->
                                        <input type="file" id="hiddenFileInput" accept=".pdf,.doc,.docx,.jpg,.png,.jpeg" style="display: none;">
                                        <!-- Add file button -->
                                        <button type="button" id="addFileBtn" class="ms-btn ms-btn-primary mb-1"> + Add File </button>
                                        <!-- File list display -->
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        <label>Upon Success, do you wish to have Process Serving File the completed
                                            Affidavit of Service with the Court on your behalf ?</label>
                                        <select name="affidavit_success_action">
                                            <option value="">Select an option</option>
                                            <option value="file_and_send">Yes, please File the Completed Affidavit of Service with the Court on my behalf and send me a Filed Copy</option>
                                            <option value="send_only">No, please send me the Completed Affidavit only</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>If Unsuccessful, do you wish to have Process Serving File the completed
                                            Affidavit of Attempted Service with the Court on your behalf ?</label>
                                        <select name="affidavit_unsuccessful_action">
                                            <option value="">Select an option</option>
                                            <option value="send_only">No, please send me the Completed Affidavit of Attempted Service and I will file them with the Court</option>
                                            <option value="file_and_send">Yes, please file the Affidavit of Attempted Service</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-column">
                                    <div class="form-section">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="recipient_email" placeholder="Email address">
                                        </div>
                                        <div class="form-group">
                                            <label>Recipient City</label>
                                            <input type="text" name="recipient_city" placeholder="City name">
                                        </div>
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea name="recipient_address" rows="3" placeholder="Enter address"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <span>Please mail the Original Affidavit(s) to the Billing Address Previously Indicated.</span>
                                </label>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" name="terms_acknowledged" style="width:auto;margin-right: 0.5rem;" required>
                                <span>Yes I have Read the above and Understand the Provisions of the Regular Service Priority I have Selected in this Submission. <span class="text-error">*</span></span>
                            </div>

                            <div class="form-group">
                                <input type="checkbox" name="final_terms" style="width:auto;margin-right: 0.5rem;" required>
                        ...
                        <div style="grid-column: 1 / -1; text-align: center; margin-top: 1rem;">
                            <button type="submit" class="ms-btn ms-btn-primary" style="padding: 12px 40px;">Submit Service Request</button>
                        </div>
